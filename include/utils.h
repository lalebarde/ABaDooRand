...
typedef std::map<std::string, std::string> map_args_t ;
typedef std::multimap<std::string, std::string> multimap_args_t ;
typedef std::pair<std::string, std::string> xmap_args_p ;
