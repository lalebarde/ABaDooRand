...
class RS_rand: public abadoorand::RandSource {
public:
    RS_rand(ABaDooRand* aAbadorand, const rng_type aRNGtype = pseudoRNG, const uint64_t aSeed = 0, const size_t aReseedPeriodMax = 1000000, char* aArgs = NULL);
    ~RS_rand();
